...
def save_speed(batch_name, speed, save_path):
    raw_data = {
...
if __name__ == '__main__': 
    ...
    BATCH_SOURCE = BasePath +'/input/' + ProjectName +'/'
    ...
    save_path = BasePath +'/output/sentimentation/speed.csv'
    save_speed(BATCH_NAME, sentimentation_speed, save_path)
